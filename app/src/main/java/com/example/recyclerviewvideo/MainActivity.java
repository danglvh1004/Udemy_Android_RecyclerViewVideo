...
//        layoutManager = new LinearLayoutManager(this, LinearLayoutManager.HORIZONTAL, false);
        ...
        people.add(new Person("Hai Dang", "Le Vu", "bus"));
        people.add(new Person("Minh Dang", "Le Vu", "bus"));
        people.add(new Person("Manh", "Le Xuan", "plane"));
        people.add(new Person("Van", "Le Hai", "plane"));
        people.add(new Person("Hai Dang", "Le Vu", "bus"));
